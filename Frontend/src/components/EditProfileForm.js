...
const EditProfileModal = ({ closeModal }) => {
    ...
    return ( <
        ...
        <
        ImageWrapper url = {!currentImageUrl && setDefaultAvatar } > { currentImageUrl && < UserImage src = { changeImage() }
            alt = "user" / > } <
        ...
        AuthFormWrapper >
        <
        ErrorSection name = "name"
        component = "div" / >
        <
        AuthFormField type = "text"
        id = "name"
        name = "name"
        ...
        AuthFormWrapper >
        <
        ErrorSection name = "password"
        component = "div" / >
        <
        AuthFormField type = { showPassword ? 'text' : 'password' }
        id = "password"
        name = "password"
        placeholder = "Enter your password" /
        >
        <
        AuthFormPasswordIcon onClick = { handleTogglePassword } > { showPassword ? < AiOutlineEyeInvisible / > : < AiOutlineEye / > } <
        /AuthFormPasswordIcon> <
        /AuthFormWrapper>
